...
object Synk {
    ...
    private var isAlwaysSynk = false
    private const val TAG = "Synk"
     ...
     **/
    fun init(context: Context, isAlwaysSynk: Boolean = false) {
        preferences = PreferenceManager.getDefaultSharedPreferences(context)
        this.isAlwaysSynk = isAlwaysSynk
    }
    ...
    fun shouldSync(key: String, window: Int = 4, unit: TimeUnit = TimeUnit.HOURS): Boolean {
        ...
        if (isAlwaysSynk) return syncIt(key)
